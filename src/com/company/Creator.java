...
public class Creator {
  ...
  public void createRooms() {
    ...
    Room room6 = new Room("Deck (Bow)", "You stand at the foot of the ships mast.\n" +
        "A robe ladder leads up to the crow's nest", new ArrayList<Item>(), new ArrayList<Door>(), null, null, new ArrayList<Box>(), new ArrayList<Inspectables>());
    ...
    room5.addToBoxes(new Box("lever", new Item ("hammer"), false, null, "You pull the lever and watch as the capstan spins dropping the anchor at rapid speed.\n" +
        "The thud of the anchor hitting sea floor shifts the ship enough that something falls from the mast.\n" +
