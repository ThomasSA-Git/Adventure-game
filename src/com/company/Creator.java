...
public class Creator {
  ...
  public void createRooms() {
    ...
    Room room1 = new Room("Cabin", "You find yourself in what looks like a cabin on a larger ship. The room has one door\n" +
        ...
        "The room contains:\n", new ArrayList<Item>(), new ArrayList<Door>(), null, null, null);
    ...
    Room room2 = new Room("Galley", "You look around to see that you find yourself in a quaint small kitchen.\n" +
        ...
        "Opposite the door where you entered, there's another white door", new ArrayList<Item>(), new ArrayList<Door>(), null, new Enemy("Troll", 50, new MeleeWeapon("club",2,3), true), null);
    ...
    Room room3 = new Room("Ship Hold", "Barrels, crates, bags and sacks. This is clearly the hold of the ship\n" +
        ...
        "", new ArrayList<Item>(), new ArrayList<Door>(), null, null,  new ArrayList<Box>());
    ...
    Room room4 = new Room("Brig", "This room smells like booze and something else absolutely ghastly.\n" +
        ...
        "After a more thorough peak you realise the bucket is full of (you guessed it) anchovies.", new ArrayList<Item>(), new ArrayList<Door>(), null, null, null);
    ...
    Room room5 = new Room("Deck (Stern)", "Finally fresh air. The ship is surrounded by ocean as far as the eye can see.\n" +
        ...
        "You look up and spot something shiny in the ship's mast", new ArrayList<Item>(), new ArrayList<Door>(), null, null, null);

    Room room6 = new Room("Deck (Bow)", "You stand at the foot of the ships mast.\n" +
        "A robe ladder leads up to the crow's nest", new ArrayList<Item>(), new ArrayList<Door>(), null, null, null);

    Room room7 = new Room("Mast", "Even with this view, there's no land in sight. There's however, a parrot sitting on the railing.\n" +
        "The parrot is screetching several controversal political opinions. How highly inapropriate.", new ArrayList<Item>(), new ArrayList<Door>(), null, null, null);
    ...
    Room room8 = new Room("Bridge Deck", "A sense of power washes over you when you stand before the ships helm.\n" +
        ...
        "On the wall is an emergency glass cabinet.", new ArrayList<Item>(), new ArrayList<Door>(), null, null, null);

    Room room9 = new Room("Captains Quarters", "", new ArrayList<Item>(), new ArrayList<Door>(), null, null, null);
