...
public class Creator {
  ...
  public void createRooms() {
    ...
    Room room2 = new Room("Galley", "You look around to see that you find yourself in a quaint small kitchen.\n" +
        ...
        "Opposite the door where you entered, there's another white door", new ArrayList<Item>(), new ArrayList<Door>(), null, null, new ArrayList<Box>());
    ...
    Room room4 = new Room("Brig", "This room smells like booze and something else absolutely ghastly.\n" +
        ...
        "After a more thorough peak you realise the bucket is full of (you guessed it) anchovies.", new ArrayList<Item>(), new ArrayList<Door>(), prisoner, null, new ArrayList<Box>());
    ...
    Room room8 = new Room("Bridge Deck", "A sense of power washes over you when you stand before the ships helm.\n" +
        ...
        "On the wall is an emergency glass cabinet.", new ArrayList<Item>(), new ArrayList<Door>(), null, null, new ArrayList<Box>());

    Room room9 = new Room("Captains Quarters", "", new ArrayList<Item>(), new ArrayList<Door>(), null, null, new ArrayList<Box>());
